...
cp -f $GITHUB_WORKSPACE/configfiles/mt7615_cr4.bin package/base-files/files/lib/firmware/mediatek/mt7615_cr4.bin
cp -f $GITHUB_WORKSPACE/configfiles/mt7615_n9.bin package/base-files/files/lib/firmware/mediatek/mt7615_n9.bin
cp -f $GITHUB_WORKSPACE/configfiles/mt7615_rom_patch.bin package/base-files/files/lib/firmware/mediatek/mt7615_rom_patch.bin
